...
// معرّف الموظف من الجلسة
$employee_id = $_SESSION['employee_id'];

// استعلام SQL لاسترجاع معلومات الورديات والموظف والمتجر
$sql = "SELECT es.id, e.employee_name, s.store_name, es.start_shift, es.end_shift
...
if ($result->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>Shift ID</th><th>Employee Name</th><th>Store Name</th><th>Start Time</th><th>End Time</th></tr>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row['start_shift'] . "</td>";
        echo "<td>" . $row['end_shift'] . "</td>";
        echo "</tr>";
    }

    echo "</table>";
} else {
    echo "No shifts found for this employee.";
}
