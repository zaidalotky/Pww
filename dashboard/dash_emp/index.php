    ...
    $conn->close();
          ...
          $conn->close();
                ...
                <div class="navbar-nav w-100">
                    <a href="index.php?id=<?php echo $employee_id; ?>" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa-solid fa-store"></i>&nbsp;&nbsp;Stores</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="biltz.php?id=<?php $employee_id = $_GET['id']; echo $employee_id; ?>&store_id=3" class="dropdown-item">Biltz</a>
                        </div>
                    </div>
