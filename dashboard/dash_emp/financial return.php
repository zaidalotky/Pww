    ...
    $conn->close();
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Damcard.php?id=<?php $employee_id = $_GET['id']; echo $employee_id; ?>" class="dropdown-item">Damcard</a>
                            <a href="jakio.php?id=<?php $employee_id = $_GET['id']; echo $employee_id; ?>" class="dropdown-item">jakio</a>
                            <a href="Biltz.php?id=<?php $employee_id = $_GET['id']; echo $employee_id; ?>" class="dropdown-item active">Biltz</a>
                        </div>
                    </div>
        ...
        <div class="content">
          ...
          if ($result->num_rows > 0) {
              ...
              $row = $result->fetch_assoc();
              $b="&nbsp;";
              echo "<span>Financial Return for   " . date('F') .   "   :"  .$b. $row['total_payment'] .$b. "SYP"."</span>";
          } else {
              echo "لم يتم العثور على معلومات الموظف";
          }
...
echo("<th>ID<th scope='col'>Store Name<th scope='col'>Shift Price");
